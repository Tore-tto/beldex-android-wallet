...
///////////////////////////
    ...
    void onAddSubAddresses() {
        try {
            SubaddressFragment fragment = (SubaddressFragment) getCurrentFragment();
            fragment.getNewSubaddress();
        } catch (ClassCastException ex) {
            // not in wallet fragment
            Timber.e(ex.getLocalizedMessage());
            // keep calm and carry on
    ...
    void updateAccountName() {
        final Wallet wallet = getWallet();
        setTitle(wallet.getName()+" ("+getWallet().getAccountLabel()+")");
    ...
    public void onAccountRename() {
        ...
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this,R.style.backgroundColor);
