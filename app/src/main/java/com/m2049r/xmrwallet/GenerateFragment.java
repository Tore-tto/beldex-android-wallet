...
public class GenerateFragment extends Fragment {
        ...
        if (FingerprintHelper.isDeviceSupported(getContext())) {
            ...
            swFingerprintAllowed.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getActivity(),R.style.backgroundColor);
    ...
    public boolean isConnected() {
        ...
        try {
            ...
            Timber.e("Connectivity Exception%s", e.getMessage());
        }
        return connected;
    }
    ...
    public void onResume() {
        super.onResume();
        Timber.d("onResume()");
        if (getType().equals(getString(R.string.generate_wallet_type_new))) {
            activityCallback.setTitle("Create New Wallet");
        } else if (getType().equals(getString(R.string.generate_wallet_type_seed))) {
            activityCallback.setTitle("Restore Wallet 25 Word Seed");
        } else if (getType().equals(getString(R.string.generate_wallet_type_key))) {
            activityCallback.setTitle("Restore Wallet from Private Keys");
        } else if (getType().equals(getString(R.string.generate_wallet_type_view))) {
            activityCallback.setTitle("Restore View Only Wallet");
        }
