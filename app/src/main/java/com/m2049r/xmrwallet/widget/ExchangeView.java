...
public class ExchangeView extends LinearLayout {
    ...
    protected void onFinishInflate() {
       ...
       /* etAmount.getEditText().setBackgroundColor(ContextCompat.getColor(getContext(),R.color.cardBackgroundColor));
        etAmount.getEditText().setHintTextColor(ContextCompat.getColor(getContext(),R.color.textColor));
        etAmount.setHintTextColor(ColorStateList.valueOf(ContextCompat.getColor(getContext(),R.color.textColor)));
        etAmount.setBoxStrokeColor(ContextCompat.getColor(getContext(),R.color.textColor));
        etAmount.setErrorEnabled(true);
        etAmount.setBoxStrokeErrorColor(ColorStateList.valueOf(ContextCompat.getColor(getContext(),R.color.textColor)));
        tvAmountB.setBackgroundColor(ContextCompat.getColor(getContext(),R.color.cardBackgroundColor));*/
