    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        private void showStar() {
            if (nodeItem.isFavourite()) {
                ...
                ibBookmark.setImageResource(R.drawable.ic_circle_border);
            }
        }
        ...
        void bind(int position) {
            ...
            if (nodeItem.isTested()) {
                if (nodeItem.isValid()) {
                    ...
                    ibBookmark.setImageResource(R.drawable.ic_circle_error);
                }
            } else {
            ...
            itemNodeRelativeLayout.setBackgroundColor(nodeItem.isSelected() ? context.getResources().getColor(R.color.greenColor):context.getResources().getColor(R.color.cardBackgroundColor));
            //showStar();
        }
