...
public class SendConfirmWizardFragment extends SendWizardFragment implements SendConfirm {
    ...
    private LinearLayout fragmentSendConfirmNotesLinearLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentSendConfirmNotesLinearLayout = view.findViewById(R.id.fragmentSendConfirmNotesLinearLayout);
